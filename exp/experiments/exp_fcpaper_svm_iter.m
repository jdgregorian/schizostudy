% Script for testing additional settings of classifiers for FC paper 
% on datasets with
...
% settings
paperSettings = fullfile(setfolder, 'fcpaperSettings_add.m');
...
additionalSettings = {nopca, pca36};
expname = 'exp_fcpaper_svm_iter';
