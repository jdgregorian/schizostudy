...
classifyFC(FCdata,'lda',settings, fullfile(filename,'lda_linear.mat'));
...
classifyFC(FCdata,'lda',settings, fullfile(filename, 'lda_prtools.mat'));
...
classifyFC(FCdata,'qda',settings, fullfile(filename,'qda_quadratic.mat'));
...
classifyFC(FCdata,'llc',settings, fullfile(filename,'llc_default.mat'));
...
classifyFC(FCdata, 'perc', settings, fullfile(filename,'perc_default.mat'));
...
classifyFC(FCdata, 'ann', settings, fullfile(filename,'ann_default.mat'));
...
classifyFC(FCdata, 'rbf', settings, fullfile(filename,'rbf_default.mat'));
