...
classifyFC(FCdata,'svm',settings,fullfile(filename,'svm_linear_pca20.mat'));
...
classifyFC(FCdata,'svm',settings, fullfile(filename,'svm_linear_noauto_pca20.mat'));
...
classifyFC(FCdata,'svm',settings, fullfile(filename,'svm_quad_pca20.mat'));
...
settings.svm.kernel_function = 'quadratic';
settings.svm.autoscale = false;
classifyFC(FCdata,'svm',settings, fullfile(filename,'svm_quad_noauto_pca20.mat'));
...
classifyFC(FCdata,'svm',settings, fullfile(filename,'svm_poly_pca20.mat'));
...
settings.svm.kernel_function = 'polynomial';
settings.svm.autoscale = false; 
classifyFC(FCdata,'svm',settings, fullfile(filename,'svm_poly_noauto_pca20.mat'));
...
classifyFC(FCdata,'svm',settings, fullfile(filename,'svm_rbf_pca20.mat'));
...
classifyFC(FCdata,'svm',settings, fullfile(filename,'svm_rbf_noauto_pca20.mat'));
...
classifyFC(FCdata,'svm',settings, fullfile(filename,'svm_mlp_pca20.mat'));
...
classifyFC(FCdata,'svm',settings, fullfile(filename,'svm_mlp_noauto_pca20.mat'));
...
classifyFC(FCdata,'mrf',settings, fullfile(filename,'mrf_11t_pca20.mat'));
...
classifyFC(FCdata,'rf',settings, fullfile(filename,'rf_lin_11t_mahal_pca20.mat'));
...
classifyFC(FCdata,'rf',settings, fullfile(filename,'rf_lin_11t_distInf_pca20.mat'));
...
classifyFC(FCdata,'rf',settings, fullfile(filename,'rf_lin_11t_dist1_pca20.mat'));
...
classifyFC(FCdata,'rf',settings, fullfile(filename,'rf_lin_11t_boost_10split_pca20.mat'));
...
classifyFC(FCdata,'rf',settings, fullfile(filename,'rf_svm_11t_pca20.mat'));
...
classifyFC(FCdata,'svmtree', settings, fullfile(filename,'svmTree_pca20.mat'));
...
classifyFC(FCdata,'mtltree',settings, fullfile(filename,'mtlTree_pca20.mat'));
...
classifyFC(FCdata,'knn',settings, fullfile(filename,'knn_1_pca20.mat'));
...
classifyFC(FCdata,'knn',settings, fullfile(filename,'knn_3_pca20.mat'));
...
classifyFC(FCdata, 'nb', settings, fullfile(filename,'nb_pca20.mat'));
...
classifyFC(FCdata, 'perc', settings, fullfile(filename,'perc_pca20.mat'));
...
classifyFC(FCdata, 'ann', settings, fullfile(filename,'ann_pca20.mat'));
